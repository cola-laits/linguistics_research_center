...
class LexLexiconCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('landing_page_content')->type('tinymce')->options($this->getDefaultTinyMceOptions(style:'lexicon'));
        CRUD::field('protolanguage_page_content')->type('tinymce')->options($this->getDefaultTinyMceOptions(style:'lexicon'));
        CRUD::field('viewer_lang_options')->label('Viewer language options')->hint('Comma-separated list of language codes to offer to the user.  ex: "en, es"');
