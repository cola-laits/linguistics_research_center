...
<h1>Indo-European Linguistics</h1>
<h2>Semantic Fields</h2>

<p>The notion of "semantic fields," or "semantic categories," is a popular topic
...
been published and used by others, with only minor technical modifications.</p>

<p>Among other work concerned with Indo-European (IE) semantics, Carl Darling Buck's
list of semantic fields (cf. <i>A Dictionary of Selected Synonyms in the Principal
Indo-European Languages</i>, 1949) has seen much use. We adopt and adapt Buck's
fields for our own semantic category scheme, and we present that scheme here.
Slightly simplifying Buck, we employ a strictly two-level organization; most semantic
