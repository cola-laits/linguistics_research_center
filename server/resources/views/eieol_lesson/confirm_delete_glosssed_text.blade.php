        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-warning">
                    <small>This action can not be undone later. The contents of this glossed text will be deleted.<br/>
                        All attached glosses will be unattached, though they will still be on file.
                    </small>
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-danger" id="delete_confirmed">Delete</button>
