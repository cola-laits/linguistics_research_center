        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-warning">
                    <small>This action can not be undone later. The contents of this gloss will be unattached from this
                        glossed text.<br/><br/>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-danger" id="delete_confirmed">Remove</button>
