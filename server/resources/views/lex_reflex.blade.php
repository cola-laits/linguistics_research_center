...
<p><b>Pokorny Etymon</b>: <span class='Unicode' lang='ine'>@homograph_number_ielex($etyma->homograph_number) {!! $etyma->entry !!}</span> &nbsp; '{!! $etyma->gloss !!}'</p>
...
@foreach($etyma->reflexes as $reflex)
    @if ($prev_family != $reflex->language->displayFamily())
        ...
        @php $prev_family=$reflex->language->displayFamily(); @endphp
    @endif
