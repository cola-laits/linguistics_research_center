...
/**
 * Clone of CKEditor 4's 'language' plugin, tweaked to allow better customization of which tags it matches,
 * since we have historical tagging in a variety of formats.  The default plugin requires and looks for a
 * 'dir' attribute; this doesn't.
 */
...
console.log(item);
			...
			editor.ui.add( 'EieolLanguage', CKEDITOR.UI_MENUBUTTON, {
				label: lang.button,
			...
			if ( editor.addRemoveFormatFilter ) {
				editor.addRemoveFormatFilter( function( element ) {
					return !( element.is( 'span' ) && element.getAttribute( 'lang' ) );
				} );
			}
		},
