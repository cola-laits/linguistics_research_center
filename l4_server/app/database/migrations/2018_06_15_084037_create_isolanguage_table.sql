...
--
-- Host: mysql.laits.utexas.edu
-- Generation Time: Jun 15, 2018 at 08:39 AM
...
CREATE TABLE IF NOT EXISTS `iso_language` (
  `id` varchar(3) COLLATE utf8mb4_bin DEFAULT NULL,
  `Part2B` varchar(3) COLLATE utf8mb4_bin DEFAULT NULL,
  `Part2T` varchar(3) COLLATE utf8mb4_bin DEFAULT NULL,
  `Part1` varchar(2) COLLATE utf8mb4_bin DEFAULT NULL,
  `Scope` varchar(1) COLLATE utf8mb4_bin DEFAULT NULL,
  `Language_Type` varchar(1) COLLATE utf8mb4_bin DEFAULT NULL,
  `Ref_Name` varchar(58) COLLATE utf8mb4_bin DEFAULT NULL,
  `Comment` varchar(42) COLLATE utf8mb4_bin DEFAULT NULL
...
INSERT INTO `iso_language` (`id`, `Part2B`, `Part2T`, `Part1`, `Scope`, `Language_Type`, `Ref_Name`, `Comment`) VALUES
('aaa', '', '', '', 'I', 'L', 'Ghotuo', ''),
('aab', '', '', '', 'I', 'L', 'Alumu-Tesu', ''),
('aac', '', '', '', 'I', 'L', 'Ari', ''),
('aad', '', '', '', 'I', 'L', 'Amal', ''),
...
('aav', NULL, NULL, NULL, NULL, 'G', 'Austro-Asiatic languages', NULL),
('afa', NULL, NULL, NULL, NULL, 'G', 'Afro-Asiatic languages', NULL),
('alg', NULL, NULL, NULL, NULL, 'G', 'Algonquian languages', NULL),
('alv', NULL, NULL, NULL, NULL, 'G', 'Atlantic-Congo languages', NULL),
('apa', NULL, NULL, NULL, NULL, 'G', 'Apache languages', NULL),
('aqa', NULL, NULL, NULL, NULL, 'G', 'Alacalufan languages', NULL),
('aql', NULL, NULL, NULL, NULL, 'G', 'Algic languages', NULL),
('ath', NULL, NULL, NULL, NULL, 'G', 'Athapascan languages', NULL),
('auf', NULL, NULL, NULL, NULL, 'G', 'Arauan languages', NULL),
('aus', NULL, NULL, NULL, NULL, 'G', 'Australian languages', NULL),
('awd', NULL, NULL, NULL, NULL, 'G', 'Arawakan languages', NULL),
('azc', NULL, NULL, NULL, NULL, 'G', 'Uto-Aztecan languages', NULL),
('bad', NULL, NULL, NULL, NULL, 'G', 'Banda languages', NULL),
('bai', NULL, NULL, NULL, NULL, 'G', 'Bamileke languages', NULL),
('bat', NULL, NULL, NULL, NULL, 'G', 'Baltic languages', NULL),
('ber', NULL, NULL, NULL, NULL, 'G', 'Berber languages', NULL),
('bh', NULL, NULL, NULL, NULL, 'G', 'Bihari languages', NULL),
('bnt', NULL, NULL, NULL, NULL, 'G', 'Bantu languages', NULL),
('btk', NULL, NULL, NULL, NULL, 'G', 'Batak languages', NULL),
('cba', NULL, NULL, NULL, NULL, 'G', 'Chibchan languages', NULL),
('ccn', NULL, NULL, NULL, NULL, 'G', 'North Caucasian languages', NULL),
('ccs', NULL, NULL, NULL, NULL, 'G', 'South Caucasian languages', NULL),
('cdc', NULL, NULL, NULL, NULL, 'G', 'Chadic languages', NULL),
('cdd', NULL, NULL, NULL, NULL, 'G', 'Caddoan languages', NULL),
('cel', NULL, NULL, NULL, NULL, 'G', 'Celtic languages', NULL),
('cmc', NULL, NULL, NULL, NULL, 'G', 'Chamic languages', NULL),
('csu', NULL, NULL, NULL, NULL, 'G', 'Central Sudanic languages', NULL),
('cus', NULL, NULL, NULL, NULL, 'G', 'Cushitic languages', NULL),
('day', NULL, NULL, NULL, NULL, 'G', 'Land Dayak languages', NULL),
('dmn', NULL, NULL, NULL, NULL, 'G', 'Mande languages', NULL),
('dra', NULL, NULL, NULL, NULL, 'G', 'Dravidian languages', NULL),
('egx', NULL, NULL, NULL, NULL, 'G', 'Egyptian languages', NULL),
('esx', NULL, NULL, NULL, NULL, 'G', 'Eskimo-Aleut languages', NULL),
('euq', NULL, NULL, NULL, NULL, 'G', 'Basque (family)', NULL),
('fiu', NULL, NULL, NULL, NULL, 'G', 'Finno-Ugrian languages', NULL),
('fox', NULL, NULL, NULL, NULL, 'G', 'Formosan languages', NULL),
('gem', NULL, NULL, NULL, NULL, 'G', 'Germanic languages', NULL),
('gme', NULL, NULL, NULL, NULL, 'G', 'East Germanic languages', NULL),
('gmq', NULL, NULL, NULL, NULL, 'G', 'North Germanic languages', NULL),
('gmw', NULL, NULL, NULL, NULL, 'G', 'West Germanic languages', NULL),
('grk', NULL, NULL, NULL, NULL, 'G', 'Greek languages', NULL),
('him', NULL, NULL, NULL, NULL, 'G', 'Himachali languages', NULL),
('hmx', NULL, NULL, NULL, NULL, 'G', 'Hmong-Mien languages', NULL),
('hok', NULL, NULL, NULL, NULL, 'G', 'Hokan languages', NULL),
('hyx', NULL, NULL, NULL, NULL, 'G', 'Armenian (family)', NULL),
('iir', NULL, NULL, NULL, NULL, 'G', 'Indo-Iranian languages', NULL),
('ijo', NULL, NULL, NULL, NULL, 'G', 'Ijo languages', NULL),
('inc', NULL, NULL, NULL, NULL, 'G', 'Indic languages', NULL),
('ine', NULL, NULL, NULL, NULL, 'G', 'Indo-European languages', NULL),
('ira', NULL, NULL, NULL, NULL, 'G', 'Iranian languages', NULL),
('iro', NULL, NULL, NULL, NULL, 'G', 'Iroquoian languages', NULL),
('itc', NULL, NULL, NULL, NULL, 'G', 'Italic languages', NULL),
('jpx', NULL, NULL, NULL, NULL, 'G', 'Japanese (family)', NULL),
('kar', NULL, NULL, NULL, NULL, 'G', 'Karen languages', NULL),
('kdo', NULL, NULL, NULL, NULL, 'G', 'Kordofanian languages', NULL),
('khi', NULL, NULL, NULL, NULL, 'G', 'Khoisan languages', NULL),
('kro', NULL, NULL, NULL, NULL, 'G', 'Kru languages', NULL),
('map', NULL, NULL, NULL, NULL, 'G', 'Austronesian languages', NULL),
('mkh', NULL, NULL, NULL, NULL, 'G', 'Mon-Khmer languages', NULL),
('mno', NULL, NULL, NULL, NULL, 'G', 'Manobo languages', NULL),
('mun', NULL, NULL, NULL, NULL, 'G', 'Munda languages', NULL),
('myn', NULL, NULL, NULL, NULL, 'G', 'Mayan languages', NULL),
('nah', NULL, NULL, NULL, NULL, 'G', 'Nahuatl languages', NULL),
('ngf', NULL, NULL, NULL, NULL, 'G', 'Trans-New Guinea languages', NULL),
('nic', NULL, NULL, NULL, NULL, 'G', 'Niger-Kordofanian languages', NULL),
('nub', NULL, NULL, NULL, NULL, 'G', 'Nubian languages', NULL),
('omq', NULL, NULL, NULL, NULL, 'G', 'Oto-Manguean languages', NULL),
('omv', NULL, NULL, NULL, NULL, 'G', 'Omotic languages', NULL),
('oto', NULL, NULL, NULL, NULL, 'G', 'Otomian languages', NULL),
('plf', NULL, NULL, NULL, NULL, 'G', 'Central Malayo-Polynesian languages', NULL),
('poz', NULL, NULL, NULL, NULL, 'G', 'Malayo-Polynesian languages', NULL),
('pqe', NULL, NULL, NULL, NULL, 'G', 'Eastern Malayo-Polynesian languages', NULL),
('pqw', NULL, NULL, NULL, NULL, 'G', 'Western Malayo-Polynesian languages', NULL),
('pra', NULL, NULL, NULL, NULL, 'G', 'Prakrit languages', NULL),
('qwe', NULL, NULL, NULL, NULL, 'G', 'Quechuan (family)', NULL),
('roa', NULL, NULL, NULL, NULL, 'G', 'Romance languages', NULL),
('sal', NULL, NULL, NULL, NULL, 'G', 'Salishan languages', NULL),
('sdv', NULL, NULL, NULL, NULL, 'G', 'Eastern Sudanic languages', NULL),
('sem', NULL, NULL, NULL, NULL, 'G', 'Semitic languages', NULL),
('sio', NULL, NULL, NULL, NULL, 'G', 'Siouan languages', NULL),
('sit', NULL, NULL, NULL, NULL, 'G', 'Sino-Tibetan languages', NULL),
('sla', NULL, NULL, NULL, NULL, 'G', 'Slavic languages', NULL),
('smi', NULL, NULL, NULL, NULL, 'G', 'Sami languages', NULL),
('son', NULL, NULL, NULL, NULL, 'G', 'Songhai languages', NULL),
('sqj', NULL, NULL, NULL, NULL, 'G', 'Albanian languages', NULL),
('ssa', NULL, NULL, NULL, NULL, 'G', 'Nilo-Saharan languages', NULL),
('syd', NULL, NULL, NULL, NULL, 'G', 'Samoyedic languages', NULL),
('tai', NULL, NULL, NULL, NULL, 'G', 'Tai languages', NULL),
('tbq', NULL, NULL, NULL, NULL, 'G', 'Tibeto-Burman languages', NULL),
('trk', NULL, NULL, NULL, NULL, 'G', 'Turkic languages', NULL),
('tup', NULL, NULL, NULL, NULL, 'G', 'Tupi languages', NULL),
('tut', NULL, NULL, NULL, NULL, 'G', 'Altaic languages', NULL),
('tuw', NULL, NULL, NULL, NULL, 'G', 'Tungus languages', NULL),
('urj', NULL, NULL, NULL, NULL, 'G', 'Uralic languages', NULL),
('wak', NULL, NULL, NULL, NULL, 'G', 'Wakashan languages', NULL),
('wen', NULL, NULL, NULL, NULL, 'G', 'Sorbian languages', NULL),
('xgn', NULL, NULL, NULL, NULL, 'G', 'Mongolian languages', NULL),
('xnd', NULL, NULL, NULL, NULL, 'G', 'Na-Dene languages', NULL),
('ypk', NULL, NULL, NULL, NULL, 'G', 'Yupik languages', NULL),
('zhx', NULL, NULL, NULL, NULL, 'G', 'Chinese (family)', NULL),
('zle', NULL, NULL, NULL, NULL, 'G', 'East Slavic languages', NULL),
('zls', NULL, NULL, NULL, NULL, 'G', 'South Slavic languages', NULL),
('zlw', NULL, NULL, NULL, NULL, 'G', 'West Slavic languages', NULL),
('znd', NULL, NULL, NULL, NULL, 'G', 'Zande languages', NULL);
